...
class DessertTableViewCell: UITableViewCell {
    ...
    func setupUI(){
        ...
        videoModel.getFeedVideos(param: "dessert recipe")
    }
    
}

extension DessertTableViewCell: SkeletonCollectionViewDataSource, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension DessertTableViewCell: VideoModelDelegate {
    func dataReady() {
